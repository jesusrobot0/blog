...
export function FancyLink({ href, text }: Props) {
  return (
    <Link
      href={href}
      className="overflow-hidden w-[258px] h-[52px] flex justify-center items-center gap-2 text-[18px] tracking-[.9px] uppercase border border-[#121212] rounded-full group hover:border-transparent hover:bg-[#AD9C94] transition-colors duration-500"
    >
      ...
      <div className="flex justify-center items-center w-[30px] h-[30px] rounded-full bg-white group-hover:rotate-45 transition-transform duration-300">
        <svg
